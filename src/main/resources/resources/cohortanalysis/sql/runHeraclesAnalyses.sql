...
(
	...
	from #HERACLES_cohort c1
		join @results_schema.heracles_periods hp on not (hp.period_end_date <= c1.cohort_start_date or hp.period_start_date >  c1.cohort_end_date) AND hp.period_type in (@periods) -- find overlapping periods with the cohort's observation periods
